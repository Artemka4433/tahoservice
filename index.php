...
<div id="main">
    ...
    <section class="aboutUs">
        ...
        <div id="underService" class="servicesUpperContent services">
            <p><h4>Мастера восстанавливают поверхность вашего автомобиля,<br/> – и создают незаметный, но очень
            эффективный.</h4></p>
        </div>
...
<footer id="footer" class="conteiners">
    ...
    <div class="aboutUs">
        <h1>Как нас найти?</h1>
        <p><h4>Адреса</h4></p>
        <p><h6 class="info">ул. Карла Маркса, 21</h6></p>
        <p><h4>Телефоны</h4></p>
        <p><h6 class="info">093 871 00 55<br/> 093 871 00 55</h6></p>
        <p><h4>Почта</h4></p>
        <p><h6 class="info">093 871 00 55<br/> 093 871 00 55</h6></p>
